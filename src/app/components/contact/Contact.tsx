          ...
          <div className="contact_content">
            ...
            <div className="contact_info">
              ...
              <div className="contact_card" data-aos="fade-up" data-aos-delay="500">
                ...
                <span className="contact_card_data">+92412849860</span>

                <a
                  href="https://api.whatsapp.com/send?phone=03412849860"
                  rel="noreferrer"
                  className="contact_button"
                  target="_blank"
                >
              ...
              <div className="contact_card" data-aos="fade-up" data-aos-delay="700">
                ...
                <span className="contact_card_data">muhammad-kashif7016</span>

                <a
                  href="http://www.linkedin.com/in/muhammad-kashif7016"
                  rel="noreferrer"
                  className="contact_button"
                  target="_blank"
                >
